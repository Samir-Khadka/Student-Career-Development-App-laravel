...
@section('title', 'Dashboard - CareerOne')
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100 border-0">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold">{{ auth()->user()->employer ? auth()->user()->employer->jobs->count() : 0 }}</h2>
                    <p class="text-muted small mb-0">Jobs posted</p>
                    <a href="{{ route('employer.jobs.create') }}" class="btn btn-primary w-100 mt-3"><i class="bi bi-plus-lg me-1"></i> Post a Job</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100 border-0">
                <div class="card-body">
                    ...
                    <a href="{{ route('jobs.index') }}" class="btn btn-outline-primary w-100 mt-3">Browse Jobs</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
    ...
    <div class="col-md-4">
        <div class="card shadow-sm border-0 bg-primary text-white">
            <div class="card-body p-4">
                ...
                <a href="{{ route('profile') }}" class="btn btn-light w-100 fw-bold">Update Profile</a>
            </div>
        </div>
    </div>
</div>
