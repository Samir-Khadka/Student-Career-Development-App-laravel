...
@section('title', 'CareerOne - Launch Your Future')
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0 animate-fade-in-up">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    @guest
                        <a href="{{ route('register') }}" class="btn btn-light btn-lg rounded-pill px-4 fw-bold shadow-lg hover-transform">
                            Get Started <i class="bi bi-arrow-right ms-2"></i>
                        </a>
                        <a href="{{ route('login') }}" class="btn btn-outline-light btn-lg rounded-pill px-4 fw-medium hover-transform">
                            Sign In
                        </a>
                    @else
                        <a href="{{ route('dashboard') }}" class="btn btn-light btn-lg rounded-pill px-4 fw-bold shadow-lg hover-transform">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-hover transition-all rounded-4 overflow-hidden group">
                    ...
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
                        <a href="{{ route('jobs.index') }}" class="btn btn-link text-decoration-none fw-bold icon-link">Find Jobs <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-hover transition-all rounded-4 overflow-hidden group">
                    ...
                    <div class="card-footer bg-transparent border-0 pb-4 text-center">
                         <a href="{{ route('mentors.index') }}" class="btn btn-link text-decoration-none fw-bold icon-link link-success">Find a Mentor <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
...
<section class="py-5 bg-gradient text-white text-center">
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-center gap-3">
            <a href="{{ route('register') }}" class="btn btn-light btn-lg rounded-pill px-5 fw-bold shadow-lg hover-transform text-primary">Get Started Now</a>
        </div>
